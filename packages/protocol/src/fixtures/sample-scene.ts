import type {SceneSnapshot} from '../schema.js';
...
export const sampleSceneSnapshot: SceneSnapshot = {
	...
	actors: [
		{
			id: 'self_kolya', type: 'self', name: 'Kolya', x: 3203, y: 3193, plane: 0,
		},
		{
			id: 'npc_goblin_1', type: 'npc', name: 'Goblin', x: 3205, y: 3194, plane: 0,
		},
		{
			id: 'player_friend', type: 'player', name: 'Friend', x: 3202, y: 3191, plane: 0,
		},
	],
	objects: [
		{
